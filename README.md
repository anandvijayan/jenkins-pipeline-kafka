...
https://drive.google.com/file/d/0B_SzCv6ITVKheTQ2TWdGbG4xSnc/view?usp=sharing
##Pre-requisites
...
Start topic
<pre>bin/kafka-topics.sh --create --zookeeper zoohost:2181 --replication-factor 3-partitions 1 --topic JenkinsPipeline</pre>
...
<pre>
-at:
  script:bash -lc "bin/kafka-console-consumer.sh --zookeeper kafkahost:2181 —topic JenkinsPipeline --from-beginning |  grep DEV|M.ear"
  unique:true
  count:20
  units:minutes
</pre>
